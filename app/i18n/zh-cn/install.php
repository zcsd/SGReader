...
return array(
	...
	'check' => array(
		'_' => '检查',
		'already_installed' => '我们检测到 SGReader 已经安装！',
		'cache' => array(
		...
		'php' => array(
			'nok' => '你的 PHP 版本为 %s，但 SGReader 最低需要 %s',
			'ok' => '你的 PHP 版本为 %s，与 SGReader 兼容',
		),
		'reload' => '再检查一遍',
		'tmp' => array(
			'nok' => '请检查 <em>%s</em> 目录权限。HTTP 服务器必须有其写入权限。',
	...
	'fix_errors_before' => '请在继续下一步前修复错误',
	'javascript_is_better' => '启用 JavaScript 会使 SGReader 工作得更好',
	'js' => array(
		'confirm_reinstall' => '重新安装 SGReader 将会重置之前的配置。你确定要继续吗？',
	),
	'language' => array(
		'_' => '语言',
		'choose' => '为 SGReader 选择语言',
		'defined' => '语言已指定',
	),
